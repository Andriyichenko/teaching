...
(1) \quad 放物線 $y = f(x)$ の頂点の座標は $\left(\ab{\textsf{\color{red}A}}, \ab{\textsf{\color{red}BC}}\right)$ である。
...
\begin{align*}
g(x) = -\left(x - \ab{\textsf{\color{red}D}} - k\right)^2 + \ab{\textsf{\color{red}E}}
\end{align*}
\\
...
(3) \quad 次の文中の $\ab{\textsf{\color{red}F}}$ には，この問いの下の選択肢 \maru{0}〜\maru{4} の中から，また，$\ab{\textsf{\color{red}G}}$ には，この問いの下の選択肢\\
...
\begin{align*} 
\left(\vec{u} \cdot \vec{v}\right)^2 = \frac{\ab{\textsf{\color{red}A}}}{\ab{\textsf{\color{red}B}}} |\vec{u}|^2 |\vec{v}|^2
\end{align*}

\noindent
を得る。$\vec{a} \cdot \vec{b} = \ab{\textsf{\color{red}C}}$ であることに注意して，この式を $x$ で表すと

\begin{align*}
x^4 - \ab{\textsf{\color{red}DE}} x^2 + \ab{\textsf{\color{red}FG}} = 0
\end{align*}
...
\begin{align*}
\left(x^2 - \ab{\textsf{\color{red}H}}\right)^2 = \left(\ab{\textsf{\color{red}I}} \sqrt{\ab{\textsf{\color{red}J}}} x\right)^2
\end{align*}
...
\begin{align*}
x = \sqrt{\ab{\textsf{\color{red}K}}} + \sqrt{\ab{\textsf{\color{red}L}}}
\end{align*}
...
\begin{align*}
\arg z = \frac{\pi}{\ab{\textsf{\color{red}M}}} k \quad (k \text{ は整数})
\end{align*}

を満たすので，図形 $C$ は $x, y$ の方程式

\begin{align*}
y = \ab{\textsf{\color{red}N}}, \quad y = \sqrt{\ab{\textsf{\color{red}O}}} x, \quad y = -\sqrt{\ab{\textsf{\color{red}P}}} x
\end{align*}
...
\qquad したがって、$t$の範囲は$t > \dfrac{\ab{\textsf{\color{red}CD}}}{\ab{\textsf{\color{red}E}}}$でなる。

\vspace{3em}
(ii) \quad $t = \abb{\textsf{\color{red}A}}$ のとき，区間 $x \leq 4$ における $f(x)$ の最大値は $f\left(\ab{\textsf{\color{red}F}}\right) = \ab{\textsf{\color{red}G}}$ となり，条件は満たされない。

\vspace{3em}
(iii) \quad $t < \abb{\textsf{\color{red}A}}$ のとき，$f(x)$ は $x = t$ で極大，$x = \abb{\textsf{\color{red}A}}$ で極小となる。また，$f(4) = \abb{\textsf{\color{red}B}}$ であるから，\\[0.5em]
...
\hspace{1cm} ここで
\begin{align*}
f(t) - 6 = -\frac{1}{6}\left(t + \ab{\textsf{\color{red}H}}\right)\left(t - \ab{\textsf{\color{red}I}}\right)^2
\end{align*}
...
(1) \quad $f(x)$ の導関数は
\begin{align*}
f'(x) = \dfrac{\ab{\textsf{\color{red}A}} \cos x - \ab{\textsf{\color{red}B}}}{\left(\ab{\textsf{\color{red}C}} - \ab{\textsf{\color{red}D}} \cos x\right)^2}
\end{align*}
